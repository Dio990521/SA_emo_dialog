...
if __name__ == "__main__":
    ...
    embeddings, word2id, word_list = read_total_embeddings('C:/Users/Willy/Desktop/NLP/dialogue/sgns.weibo.char', max_vocab_size)
    embeddings = get_norm_embeddings(embeddings)

    print("read response data")
    generate_response = read_response_file('C:/Users/Willy/Desktop/test_response.txt', word2id)
    true_response = read_response_file('C:/Users/Willy/Desktop/stc_reference_ori.txt', word2id)
